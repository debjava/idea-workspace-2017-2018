...
public class CompletionStageAndCompletableFutureExample {
  ...
  public static void main(String[] args) {
    ...
    System.out.format(
        "compFut value and received at: %f, %s \n", completableFuture1.join(), new Date());

    // 2. chaining multiple CompletionStages dependencies - the "either" construct
    /**
     * A CompletionStage may have either/or completion dependency with other CompletionStages: In
     * the following snippet, completableFutureForAcptEither depends on the completion of either
     * CompletableFuture2 or CompletableFuture3
     */
    ...
    CompletableFuture<Void> completableFutureForAcptEither =
        completableFuture2.acceptEitherAsync(
            completableFuture3,
            (val) -> {
    ...
    CompletableFuture<Double> completableFuture5 =
        completableFuture4.thenComposeAsync(
            (compFut4) -> {
              if (compFut4 == 100) {
    ...
    System.out.println(
        "Is completableFuture7 completed with exception: "
